...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 06, 2017 lúc 06:32 SA
...
(1, 'Mr. Master Admin', '', '', 'admin@florise.co', 'cd5ea73cd58f827fa78eef7197b8ee606c99b2e6', '1', '1499315483'),
...
(26, 'home_def_currency', '', '1'),
(27, 'c2_set', NULL, 'ok'),
(28, 'c2_user', NULL, NULL),
(29, 'c2_secret', NULL, NULL),
(30, 'c2_type', NULL, NULL),
(31, 'currency_format', NULL, 'us'),
(32, 'symbol_format', NULL, 's_amount'),
(33, 'no_of_decimals', NULL, '2'),
(34, 'vp_set', NULL, NULL),
(35, 'vp_merchant_id', NULL, NULL);
...
('dd61b8ade7829cdfeaa9c1927f98c5ffcaef0312', '::1', 1499315483, );
...
--
-- Cấu trúc bảng cho bảng `currency_settings`
--
...
--
-- Đang đổ dữ liệu cho bảng `currency_settings`
--
...
(7, 'Users Account Opening', 'Account Opening', '<p><span [removed]=\"font-weight: bold;\">Hi [[to]],</span></p><p><span [removed]=\"font-weight: bold;\">Thank you for registering at our site&nbsp;</span>[[sitename]]<span [removed]=\"font-weight: bold;\">.</span></p><p><span [removed]=\"font-weight: bold;\">Your account type is : [[account_type]]</span></p><p><span [removed]=\"font-weight: bold;\">Email is : [[email]]</span></p><p><span [removed]=\"font-weight: bold;\"></span></p><p><span [removed]=\"font-weight: bold;\">Password is : [[password]]</span></p><p>Login from here : [[url]]</p><p><span [removed]=\"font-weight: bold;\">Please contact with the&nbsp;</span>administration&nbsp;team if you have any further question. Best wishes.<br></p><p><span [removed]=\"font-weight: bold;\"><br></span></p><p><span [removed]=\"font-weight: bold;\">Thanks,</span></p><p><span [removed]=\"\" bold;\"=\"\">[[from]]</span></p>'),
(8, 'Admins Account Opening', 'Account Opening', '<p><span [removed]=\"font-weight: bold;\">Hi [[to]],</span></p><p><span [removed]=\"font-weight: bold;\">Thank you for joining at our site&nbsp;</span>[[sitename]]<span [removed]=\"font-weight: bold;\">.</span></p><p><span [removed]=\"font-weight: bold;\">Your account type is : [[account_type]]</span></p><p><span [removed]=\"font-weight: bold;\">Email is : [[email]]</span></p><p><span [removed]=\"font-weight: bold;\"></span></p><p><span [removed]=\"font-weight: bold;\">Password is : [[password]]</span></p><p>Login from here : [[url]]</p><p>&nbsp;Best wishes.</p><p><br></p><p><span [removed]=\"font-weight: bold;\">Thanks,</span></p><p><span [removed]=\"\" bold;\"=\"\">[[from]]</span></p>');
...
(1, 'system_name', 'Florise '),
(2, 'system_email', 'admin@shop.com'),
(3, 'system_title', 'Florise '),
(4, 'address', ''),
(5, 'phone', ''),
(6, 'language', 'english'),
...
(1009, 'pay_to_vendor', 'Pay To Vendor', NULL, NULL, NULL, NULL, NULL),
(1010, 'package_payments', 'Package Payments', NULL, NULL, NULL, NULL, NULL),
(1011, 'email_templates', 'Email Templates', NULL, NULL, NULL, NULL, NULL),
(1012, 'twocheckout_payment_enabled!', 'Twocheckout Payment Enabled!', NULL, NULL, NULL, NULL, NULL),
(1013, 'twocheckout_payment_disabled!', 'Twocheckout Payment Disabled!', NULL, NULL, NULL, NULL, NULL),
(1014, 'voguePay_payment_enabled!', 'VoguePay Payment Enabled!', NULL, NULL, NULL, NULL, NULL),
(1015, 'voguePay_payment_disabled!', 'VoguePay Payment Disabled!', NULL, NULL, NULL, NULL, NULL),
(1016, 'successfully_enabled!', 'Successfully Enabled!', NULL, NULL, NULL, NULL, NULL),
(1017, 'successfully_disabled!', 'Successfully Disabled!', NULL, NULL, NULL, NULL, NULL),
(1018, 'state', 'State', NULL, NULL, NULL, NULL, NULL),
(1019, 'country', 'Country', NULL, NULL, NULL, NULL, NULL),
(1020, 'i_agree_with', 'I Agree With', NULL, NULL, NULL, NULL, NULL),
(1021, 'terms_&_conditions', 'Terms & Conditions', NULL, NULL, NULL, NULL, NULL),
(1022, 'you_must_agree_with_terms_&_conditions', 'You Must Agree With Terms & Conditions', NULL, NULL, NULL, NULL, NULL);
...
--
-- Cấu trúc bảng cho bảng `membership_payment`
--
...
--
-- Đang đổ dữ liệu cho bảng `membership_payment`
--
...
(103, 'Pay to Vendor', 'pay_to_vendor', 'parent', NULL),
(104, 'email_template', 'email_template', 'parent', NULL);
...
(99, 0, 0, '[]', 'Colored Solution', '{\"type\":\"admin\",\"id\":\"1\"}', 13, '                                                                                <p>Lorem Ipsum is simply dummy text of the printing and \r\ntypesetting industry. Lorem Ipsum has been the industry\'s standard dummy\r\n text ever since the 1500s, when an unknown printer took a galley of \r\ntype and scrambled it to make a type specimen book. It has survived not \r\nonly five centuries, but also the leap into electronic typesetting, \r\nremaining essentially unchanged. It was popularised in the 1960s with \r\nthe release of Letraset sheets containing Lorem Ipsum passages, and more\r\n recently with desktop publishing software like Aldus PageMaker \r\nincluding versions of Lorem Ipsum</p><p>Lorem Ipsum is simply dummy text of the printing and \r\ntypesetting industry. Lorem Ipsum has been the industry\'s standard dummy\r\n text ever since the 1500s, when an unknown printer took a galley of \r\ntype and scrambled it to make a type specimen book. It has survived not \r\nonly five centuries, but also the leap into electronic typesetting, \r\nremaining essentially unchanged. It was popularised in the 1960s with \r\nthe release of Letraset sheets containing Lorem Ipsum passages, and more\r\n recently with desktop publishing software like Aldus PageMaker \r\nincluding versions of Lorem Ipsum</p>                                                                        ', 75, '3', '26.00', '20.00', '0', '1476001190', 'ok', 'printing solutioncolor,color', 'ok', NULL, NULL, 0, NULL, '{\"name\":\"null\",\"value\":\"null\"}', 3, NULL, '', 'percent', '', 'percent', NULL, NULL, '0', 'ok', '99_c04a03c2506a4ba12d38_printing solution.zip', 'ok', 0, '1476360456', '[{\"index\":0,\"field\":\"Package\",\"desc\":\"<p>Full<\\/p>\"}]', 'digital_logo_99.jpg', '[]', 1499315245),
...
--
-- Cấu trúc bảng cho bảng `slider_style`
--
...
--
-- Đang đổ dữ liệu cho bảng `slider_style`
--
...
--
-- Cấu trúc bảng cho bảng `ticket_message`
--
...
--
-- Đang đổ dữ liệu cho bảng `ticket_message`
--
...
--
-- Cấu trúc bảng cho bảng `ui_settings`
--
...
--
-- Đang đổ dữ liệu cho bảng `ui_settings`
--
...
(40, 'email_theme_style', 'style_1'),
(41, 'email_theme_style_2', '<div style=\"margin: 0px 10px; background: #45a9b9; padding: 30px;\"><div style=\"margin: 0px auto; background: #eff7ff; padding: 30px;\">[[body]]</div></div>'),
(42, 'email_theme_style_3', '<div style=\"margin: 0px 10px; background: repeating-linear-gradient(-45deg, red 0, red 1em, #fffdeb 0, #fffdeb 2em, #58a 0, #58a 3em, #fffdeb 0, #fffdeb 4em); padding: 15px;\"><div style=\"margin: 0px auto; background: #fffdeb; padding: 30px;\">[[body]]</div></div>'),
(43, 'email_theme_style_4', '<div style=\"margin: 0px 10px; background: #f7f7f7; padding: 30px;\"><div style=\"padding: 30px; background: #76cece; border-radius:5px 5px 0px 0px; box-shadow: 0px -1px 7px #616565; display:block;\"><div style=\"background-image:url([[logo]]); background-repeat:no-repeat; height:80px; width:auto; display:block;\"></div></div><div style=\"margin: 0px auto; background: rgba(255, 255, 255, 0.91); padding: 30px; box-shadow: 0px 3px 7px #616565; border-radius:0px 0px 5x 5px;\">[[body]]</div></div>');
...
INSERT INTO `user` (`user_id`, `username`, `surname`, `email`, `phone`, `address1`, `address2`, `city`, `zip`, `langlat`, `password`, `fb_id`, `g_id`, `g_photo`, `creation_date`, `google_plus`, `skype`, `facebook`, `wishlist`, `last_login`, `user_type`, `user_type_till`, `left_product_type`, `downloads`, `country`, `state`) VALUES
(1, 'rorurehy', 'Fleming', 'miromumyp@yahoo.com', '+532-55-5730682', 'Fuga Enim necessitatibus proident omnis quis aut voluptatibus iste dolore quis neque adipisicing ut', 'Et ea vitae porro error labore impedit autem voluptates vel voluptas dolores mollitia', 'Voluptatem totam sit in fugiat delectus illo aliquam culpa dolor', '88604', '', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', NULL, NULL, NULL, '1474453509', NULL, NULL, NULL, '[]', '1475659729', 'default', NULL, '[]', '[]', NULL, NULL),
(2, 'rorurehy', 'Fleming', 'miromumyp1@yahoo.com', '+532-55-5730682', 'Fuga Enim necessitatibus proident omnis quis aut voluptatibus iste dolore quis neque adipisicing ut', 'Et ea vitae porro error labore impedit autem voluptates vel voluptas dolores mollitia', 'Voluptatem totam sit in fugiat delectus illo aliquam culpa dolor', '88604', '', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', NULL, NULL, NULL, '1474453555', NULL, NULL, NULL, '[]', '1474453573', 'default', NULL, '[]', '[]', NULL, NULL),
(3, 'john Doe', NULL, 'flood8289@gmail.com', '1000452345', 'Demo address  line 1', 'Demo address  line 2', 'Newyork', '1234', '(40.7127837, -74.00594130000002)', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', NULL, NULL, NULL, '1474454007', '', '', '', '[\"63\",\"100\",\"99\",\"73\",\"71\",\"57\",\"55\",\"82\",\"83\"]', '1476179570', 'default', NULL, '[]', '[{\"sale\":1,\"product\":\"44\"}]', NULL, NULL),
(4, 'Developer Activeitzone', NULL, 'required', NULL, NULL, NULL, NULL, NULL, NULL, '8cb623db6471', NULL, '107111794830756336948', 'https://lh3.googleusercontent.com/-XdUIqdMkCWA/AAAAAAAAAAI/AAAAAAAAAAA/4252rscbv5M/photo.jpg?sz=50', '1475421685', NULL, NULL, NULL, '[]', '1475421685', 'default', NULL, '[]', '[]', NULL, NULL),
(7, 'Zahid Hasan', 'Alvi', 'customer.demo@gmail.com', '+8801867225609', 'Niketon, Gulshan', 'Dhaka, Bangladesh', 'Dhaka', '1219', '(23.7737497, 90.4118585)', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', NULL, NULL, NULL, '1475479276', NULL, NULL, NULL, '[]', '1475497130', 'default', NULL, '[]', '[]', NULL, NULL);
...
--
-- Cấu trúc bảng cho bảng `vendor_invoice`
--
...
--
-- Chỉ mục cho bảng `currency_settings`
--
...
--
-- Chỉ mục cho bảng `membership_payment`
--
...
--
-- Chỉ mục cho bảng `ticket_message`
--
ALTER TABLE `ticket_message`
  ADD PRIMARY KEY (`ticket_message_id`);

--
-- Chỉ mục cho bảng `ui_settings`
--
...
--
-- Chỉ mục cho bảng `vendor_invoice`
--
...
--
-- AUTO_INCREMENT cho bảng `currency_settings`
--
ALTER TABLE `currency_settings`
  MODIFY `currency_settings_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
-- AUTO_INCREMENT cho bảng `email_template`
--
ALTER TABLE `email_template`
  MODIFY `email_template_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT cho bảng `general_settings`
--
ALTER TABLE `general_settings`
  MODIFY `general_settings_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;
--
-- AUTO_INCREMENT cho bảng `language`
--
ALTER TABLE `language`
  MODIFY `word_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1023;
--
...
--
-- AUTO_INCREMENT cho bảng `membership_payment`
--
ALTER TABLE `membership_payment`
...
--
-- AUTO_INCREMENT cho bảng `slider_style`
--
ALTER TABLE `slider_style`
...
--
-- AUTO_INCREMENT cho bảng `social_links`
--
ALTER TABLE `social_links`
...
--
-- AUTO_INCREMENT cho bảng `ticket_message`
--
ALTER TABLE `ticket_message`
  MODIFY `ticket_message_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT cho bảng `ui_settings`
--
ALTER TABLE `ui_settings`
  MODIFY `ui_settings_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
--
...
--
-- AUTO_INCREMENT cho bảng `vendor_invoice`
--
ALTER TABLE `vendor_invoice`
